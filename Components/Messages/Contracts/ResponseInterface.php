...
interface ResponseInterface extends MessageInterface
{
     ...
     * reason phrase. If no reason phrase is specified, implementations MAY
     * choose to default to the RFC 7231 or IANA recommended reason phrase for
     * the response's status code. This method MUST be implemented in such a
     * way as to retain the immutability of the message, and MUST return an
